...
(function (global) {
  ...
  var SETUP_GUIAS = {
    ...
    5: { l1: 'Fase y horas de luz → objetivos EC/VPD.' },
    6: { l1: 'SOG o SCROG; foto o auto.' },
    7: { l1: 'Genética, semillero o checklist esquejes según origen.' },
    8: { l1: 'Resumen; siguiente: geometría del sistema.' },
    9: { l1: 'Filas, cubos y depósito; diagrama en vivo.' },
    10: { l1: 'Circuito hidro, sala, herramientas.' },
    11: { l1: 'Agua del depósito y medio en net pot.' },
    12: { l1: 'Nutriente para dosis según litros calculados.' },
    13: { l1: 'Exterior: ciudad para meteo (interior salta).' },
    14: { l1: 'Variedad y fecha por cesta con cultivo.' },
    15: { l1: 'Varias salas: nombra instalaciones (Veg, Flor…).' },
  };

  var SETUP_ROADMAP = [
    { id: 'inicio', label: 'Inicio', pages: [0] },
    { id: 'origen', label: 'Origen', pages: [1] },
    { id: 'sala', label: 'Sala', pages: [2, 3, 4, 5] },
    { id: 'planta', label: 'Planta', pages: [6, 7] },
    { id: 'hidro', label: 'Hidro', pages: [8, 9, 10] },
    { id: 'mezcla', label: 'Mezcla', pages: [11, 12] },
    { id: 'cultivo', label: 'Cultivo', pages: [13, 14, 15] },
  ];
